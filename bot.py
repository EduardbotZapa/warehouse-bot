    ...
    resp = _claude.messages.create(
        ...
        messages=[{"role": "user", "content": [
            ...
            {"type": "text", "text": (
                ...
                "   Серийник может быть любого формата\n"
                "   ГЛАВНОЕ ПРАВИЛО — различай 6 и 8:\n"
                "   6 — ОДИН кружок только снизу, сверху открыто\n"
                "   8 — ДВА кружка, один над другим, оба закрыты\n"
                "   На этикетках Siemens цифра 6 встречается ОЧЕНЬ ЧАСТО\n"
                "   Если видишь цифру с одним кружком снизу — это 6, не 8\n"
                "   Другие правила:\n"
                "   0 vs O: ноль — вытянутый овал; буква О — круглая\n"
                "   Q vs O: Q имеет маленький хвостик снизу-справа\n"
                "   R vs P: у R есть ножка вправо, у P нет\n"
                "   1 vs I: смотри на контекст\n"
