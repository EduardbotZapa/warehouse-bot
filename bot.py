    ...
    resp = _claude.messages.create(
        ...
        messages=[{"role": "user", "content": [
            ...
            {"type": "text", "text": (
                ...
                "   Найди букву 'S' или 's' на этикетке — после неё идёт серийник\n"
                "   Серийник может быть любого формата, например:\n"
                "   C-R3FQ6284, V-T7M04LZH, LBT1137487, RRT9, C-RNA2A12Z\n"
                "   Читай ВСЕ символы максимально внимательно\n"
                "   КАК РАЗЛИЧАТЬ ПОХОЖИЕ СИМВОЛЫ:\n"
                "   6 vs 8: шестёрка имеет один кружок снизу, восьмёрка — два кружка\n"
                "   0 vs O: ноль — вытянутый, часто с чертой; буква О — круглая\n"
                "   Q vs O: Q имеет маленький хвостик снизу-справа\n"
                "   R vs P: у R есть ножка вправо, у P нет\n"
                "   1 vs I vs L: смотри на контекст и соседние символы\n"
                "   B vs 8: буква B имеет плоскую левую сторону\n"
                "   НИКОГДА не придумывай — если символ не виден чётко, верни пустую строку\n\n"
